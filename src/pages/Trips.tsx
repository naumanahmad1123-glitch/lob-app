    ...
    <AppLayout>
      <div className="max-w-lg mx-auto px-4">
        ...
        <AnimatePresence>
          {showAddTrip && (
            <>
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setShowAddTrip(false)} className="fixed inset-0 z-[60] bg-background/60 backdrop-blur-sm" />
