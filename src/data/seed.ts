...
export const lobs: Lob[] = [
  {
    ...
    timeOptions: [
      { id: 't1', datetime: '2026-02-27T19:00', votes: ['u2', 'u3', 'u4'] },
      { id: 't2', datetime: '2026-02-27T20:00', votes: ['u1', 'u6'] },
    ],
    quorum: 6,
    status: 'voting',
    responses: [
  ...
  },
  {
    ...
    timeOptions: [
      { id: 't3', datetime: '2026-02-27T19:30', votes: ['u1', 'u2', 'u5'] },
    ],
    selectedTime: '2026-02-27T19:30',
    quorum: 3,
    status: 'confirmed',
    responses: [
  ...
  },
  {
    ...
    timeOptions: [
      { id: 't4', datetime: '2026-02-28T09:00', votes: ['u6'] },
    ],
    quorum: 2,
    status: 'voting',
    responses: [
  ...
  },
  {
    ...
    timeOptions: [
      { id: 't5', datetime: '2026-03-01T17:00', votes: ['u4', 'u1'] },
      { id: 't6', datetime: '2026-03-01T18:00', votes: ['u4'] },
    ],
    quorum: 4,
    status: 'voting',
    responses: [
