...
export const lobs: Lob[] = [
  ...
  },
  {
    ...
    tripPlanningMode: 'defined',
    tripPlanningPhase: 'confirmed',
    timeOptions: [
  ...
  },
  {
    ...
    tripPlanningMode: 'dates-open',
    tripPlanningPhase: 'voting-dates',
    tripTimeframe: 'Sometime in August',
    timeOptions: [],
    dateRangeOptions: [
      { id: 'dr1', startDate: '2026-08-01', endDate: '2026-08-10', votes: ['u3', 'u1'] },
      { id: 'dr2', startDate: '2026-08-15', endDate: '2026-08-24', votes: ['u5'] },
    ],
    quorum: 3,
    status: 'voting',
    responses: [
  ...
  },
  {
    ...
    groupId: 'g1',
    groupName: 'Hoop Squad',
    tripPlanningMode: 'fully-open',
    tripPlanningPhase: 'voting-destination',
    tripTimeframe: 'Q3 2026',
    tripBudget: '$1k–2k per person',
    tripVibes: ['adventure', 'beach'],
    destinationOptions: [
      { id: 'dest1', name: 'Costa Rica', votes: ['u2', 'u1'] },
      { id: 'dest2', name: 'Croatia', votes: ['u4'] },
      { id: 'dest3', name: 'Bali', votes: ['u2', 'u4', 'u7'] },
    ],
    timeOptions: [],
    quorum: 4,
    status: 'voting',
    responses: [
      ...
      { userId: 'u1', response: 'in' },
      { userId: 'u4', response: 'in' },
      { userId: 'u7', response: 'maybe' },
    ],
    createdAt: '2026-03-04T14:00',
  },
];
